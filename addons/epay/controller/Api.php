...
class Api extends Controller
{
   ...
   /*     $out_trade_no = $this->request->request("out_trade_no");
      ...
      /*  $params = [
        ...
        var_dump($params);
        //$this->success('下单成功',$params);
    /*    $params = [
            'amount'=>"99.9",
            'orderid'=>"NUM2022100603850",
            'type'=>"wechat",
            'title'=>"订单标题",
            'notifyurl'=>"http://hospital.gov:83/addons/epay/api/notifyx/type/wechat",
            'returnurl'=>"http://hospital.gov:83/addons/epay/api/returnx/type/wechat",
            'method'=>"miniapp",
            'openid'=>"oXDcA6edv5B4t2Eqh1Be1cJN765U",
            'auth_code'=>""
        ];*/
        //return $params;
